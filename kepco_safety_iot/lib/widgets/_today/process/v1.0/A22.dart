...
class A22 extends StatefulWidget {
  const A22(
      {Key? key,
  ...
  @override
  State<A22> createState() => _A22State();
}

class _A22State extends State<A22> {
  ...
  void initState() {
    ...
    dangerCheck = [
      RowState(
        contents: "케이블 절연 손상으로 인한 감전 주의",
        warnCn: [RiskState(contents: "케이블 외관점검 시행 필요")],
      ),
    ];
