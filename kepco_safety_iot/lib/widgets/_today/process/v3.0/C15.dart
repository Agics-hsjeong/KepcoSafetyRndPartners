...
class _C15State extends State<C15> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    dangerCheck = [
      ...
      RowState(
        contents: "점퍼선 절분 전 점퍼선 절단대상 사전표식 여부 확인",
        warnCn: [
          RiskState(contents: "작업 책임자는 공사용 개폐기를 투입 전 모든 작업자에게 개폐기 투입 예정을 안내한다")
        ],
      ),
    ];
