...
class C23 extends StatefulWidget {
  ...
  @override
  State<C23> createState() => _C23State();
}

class _C23State extends State<C23> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    dangerCheck = [
      RowState(
        ...
        warnCn: [
          RiskState(
              contents: "공사용 개폐기 투입 후 입상케이블을 중성선에 접촉시켜 잔류전하를 방전 한다 (2~3회 반복한다)")
        ],
      ),
    ];
