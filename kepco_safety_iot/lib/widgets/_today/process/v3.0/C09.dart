...
class C09 extends StatefulWidget {
  const C09({
    Key? key,
  ...
  @override
  State<C09> createState() => _C09State();
}

class _C09State extends State<C09> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    dangerCheck = [
      RowState(
        contents: "활선작업차 버킷 내에 보조 거치대가 설치될 위치를 선정한다.",
        warnCn: [RiskState(contents: "")],
      ),
      RowState(
        contents: "보조거치대의 조절용 나사를 조여 활선작업차 버킷에 밀착시킨다.",
        warnCn: [RiskState(contents: "")],
      ),
    ];
