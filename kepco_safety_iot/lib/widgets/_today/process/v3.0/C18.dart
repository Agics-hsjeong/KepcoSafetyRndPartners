...
class C18 extends StatefulWidget {
  ...
  @override
  State<C18> createState() => _C18State();
}

class _C18State extends State<C18> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    allStages = [
      SingleRowState(contents: "사전작업 종료 후 단락접지 시행", isChecked: [true, false]),
    ];

    tableBox = TableBox(title: "작업구간 내 단락접지 철거", list: allStages);
    super.initState();
  }
