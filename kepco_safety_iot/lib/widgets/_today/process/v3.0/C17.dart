...
class C17 extends StatefulWidget {
  ...
  @override
  State<C17> createState() => _C17State();
}

class _C17State extends State<C17> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    dangerCheck = [
      RowState(
        contents: "사선 및 활선구간 착각에 의한 감전사 주의",
        warnCn: [
          RiskState(contents: "활선접근 경보기, 검전기 시용 및 단락접지 시행"),
          RiskState(contents: "사활선 구간 구획 표시")
        ],
      ),
    ];
