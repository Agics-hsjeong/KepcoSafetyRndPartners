...
class C04 extends StatefulWidget {
  ...
  @override
  State<C04> createState() => _C04State();
}
...
class _C04State extends State<C04> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    dangerCheck = [
      RowState(
        contents: "작업자는 작업자는 추락방지용 안전대를 활선 절연버킷내 고리에 고정시킨다.",
        warnCn: [RiskState(contents: "특고압 고무절연 장갑, 보호용 가죽장갑, 고무절연소매는 필요시 착용")],
      ),
      RowState(
        contents: "주작업자는 부하전류 측정기를 이용하여 작업 구간의 부하전류 측정한다.",
        warnCn: [RiskState(contents: "")],
      ),
      RowState(
        contents: "부하전류가 바이패스 케이블의 허용전류 이상일 경우에 작업 책임자는 배전센터에 연락하여 부하전환을 의뢰한다.",
        warnCn: [RiskState(contents: "")],
      ),
    ];
