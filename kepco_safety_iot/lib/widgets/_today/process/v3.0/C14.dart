...
class C14 extends StatefulWidget {
  ...
  @override
  State<C14> createState() => _C14State();
}

class _C14State extends State<C14> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    dangerCheck = [
      RowState(
        contents: "분기선로에 입상케이블을 접속 시 특고압 검상기로 상일치 여부를 확인한다.",
        warnCn: [RiskState(contents: "")],
      ),
      RowState(
        contents: "입상케이블 접속지점에 피박기를 사용하여 전선의 피복을 벗긴다.",
        warnCn: [RiskState(contents: "")],
      ),
      RowState(
        contents: "피복이 벗겨진 전력선에 임시걸이 일체형 케이블 클램프를 사용하여 입상케이블 클램프를 접속한다.",
        warnCn: [RiskState(contents: "")],
      ),
    ];
