...
class C05 extends StatefulWidget {
  const C05({
    Key? key,
  ...
  @override
  State<C05> createState() => _C05State();
}

class _C05State extends State<C05> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    dangerCheck = [
      RowState(
        contents: "충분한 절연 효과가 있는 방호망, 절연덮개 사용",
        warnCn: [
          RiskState(contents: "특고압 입상주의 방호구를 먼저 철거한 후 저압선 및 중성선 방호구를 철거 지시")
        ],
      ),
    ];
