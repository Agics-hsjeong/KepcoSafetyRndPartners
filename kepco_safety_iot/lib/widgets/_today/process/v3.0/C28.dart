...
class C28 extends StatefulWidget {
  ...
  @override
  State<C28> createState() => _C28State();
}

class _C28State extends State<C28> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    dangerCheck = [
      RowState(
        contents: "작업 마무리 시 방심 주의",
        warnCn: [RiskState(contents: "민원이 발생되지 않도록 현장 주변을 정리한다.")],
      ),
    ];
