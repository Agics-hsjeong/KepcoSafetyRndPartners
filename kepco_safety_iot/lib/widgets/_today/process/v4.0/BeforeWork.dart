...
class BeforeWork extends StatefulWidget {
  const BeforeWork({
    Key? key,
  ...
  @override
  State<BeforeWork> createState() => _BeforeWorkState();
}

class _BeforeWorkState extends State<BeforeWork> with TickerProviderStateMixin {
  late ProgressTimeline progressTimeline;
  bool safrUserCheck = false;
  bool errorCheck = false;

  void isCheck() {
    if (errorCheck && safrUserCheck) {
      setState(() {
        isNext = true;
      });
    } else {
